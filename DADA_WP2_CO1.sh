...
## Job name
#SBATCH --job-name=DADA_WP2_CO1
## Job stdout file
#SBATCH --output=DADA_WP2_CO1.out%J
## Job stderr file
#SBATCH --error=DADA_WP2_CO1.err%J
...
#SBATCH -p highmem
## Rough amount of time the job will take to run 
#SBATCH -t 72:00:00
#############################
