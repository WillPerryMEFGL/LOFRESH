...
## Job name
#SBATCH --job-name=cutadapt_demultiplexWP2CO1
## Job stdout file
#SBATCH --output=cutadapt_demultiplexWP2CO1.out%J
## Job stderr file
#SBATCH --error=cutadapt_demultiplexWP2CO1.err%J
...
perl 2_cutadapt_WP2_CO1.pl FastqList_WP2